    ...
    },
    {
        ...
        description: {
            sr: [
                ...
                '7–10 godina:',
                '- Telep, Subotička 8',
                '- Telep, Mesna zajednica, Janošikova 1',
            ...
            en: [
                ...
                'Ages 7–10:',
                '- Telep, Subotička 8',
                '- Telep, Community Center, Janošikova 1',
        ...
        addresses: [
            ...
            {
                street: 'Mileve Marić 25 (iza zgrade, atomsko sklonište)',
                city: 'Novi Sad',
            ...
            {
                street: 'Mesna zajednica, Janošikova 1',
                city: 'Novi Sad',
                district: 'Južni Telep',
                lat: 45.2332493,
                lng: 19.814817,
            },
            {
                street: 'OŠ „Branko Radičević”, Futoška 5',
                city: 'Novi Sad',
                district: 'Grbavica',
                lat: 45.2508487,
                lng: 19.8362216,
            ...
            {
                street: 'OŠ „Jovan Jovanović Zmaj”, Školska 3',
                city: 'Novi Sad',
            ...
            {
                street: 'Mesna zajednica, Vuka Karadžića 289',
                city: 'Novi Sad',
                district: 'Čenej',
                lat: 45.3693555,
                lng: 19.8008222,
